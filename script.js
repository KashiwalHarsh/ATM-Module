...
const firebaseConfig = {
    apiKey: "AIzaSyCjMNAjt4HcXW1wzAiCQjUTTUcECiWqwWY",
    authDomain: "atm---pro.firebaseapp.com",
    projectId: "atm---pro",
    storageBucket: "atm---pro.appspot.com",
    messagingSenderId: "1074672710416",
    appId: "1:1074672710416:web:727b63d8f0a922decc2b95"
};
    ...
    function registerValidation() {
        ...
        if (rAccName !== null && rAccNo.match(accNoPat) && rAccPin.match(accPinPat) && rAccPin == rConAccPin) {
            ...
            set(ref(db, "accNo " + rAccNo + "/received"), {
                ...
                alert("Recieved amount update Failed\n" + error);
            });
        }
        else {
            alert("Please enter valid Details");
    ...
    function portal(accNo, accPin) {
        ...
        function deposit() {
            ...
            document.getElementById("dep-submit").addEventListener('click', function () {
                ...
                if (depositAmt >= 100) {
                    ...
                    alert('Minimun deposit amount Rs.100');
                }
            });
        }
        ...
        function withdraw() {
            ...
            document.getElementById("wit-submit").addEventListener('click', function () {
                ...
                if (withdrawAmt >= 100) {
                    ...
                    alert('Minimun withdraw amount Rs.100');
                }
            });
        }
        ...
        function transfer() {
            ...
            document.getElementById("trans-submit").addEventListener('click', function () {
                document.getElementById('transfer-btn').removeEventListener('click', deposit);
                ...
                if (transAccNo.match(accNoPat) && transferAmt >= 100) {
                    ...
                    update(ref(db,'accNo '+transAccNo+"/received"),{
                        ...
                        document.getElementById('transfer-amt').value = '';
                        msg = "Rs. " + transferAmt + " was successfully transfered to "+transAccNo;
                        updateAvalBal(msg, totalBal);
                    }).catch((error)=>{
                        alert('error\n'+error);
                    });
